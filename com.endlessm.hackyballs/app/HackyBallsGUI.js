...
// note that "parameters" is defined globally 		
		...
		y += 10; _userInterface.createSlider( x, y, w, h, "radius",    		BALL_MIN_RADIUS,  		BALL_MAX_RADIUS,  		_parameters.radius_0 	);
		y += 30; _userInterface.createSlider( x, y, w, h, "gravity",   		BALL_MIN_GRAVITY, 		BALL_MAX_GRAVITY, 		_parameters.gravity_0 	);
		y += 30; _userInterface.createSlider( x, y, w, h, "collision", 		BALL_MIN_COLLISION, 	BALL_MAX_COLLISION, 	_parameters.collision_0 );
		y += 30; _userInterface.createSlider( x, y, w, h, "air friction",	BALL_MIN_AIR_FRICTION, 	BALL_MAX_AIR_FRICTION, 	_parameters.friction_0	);
