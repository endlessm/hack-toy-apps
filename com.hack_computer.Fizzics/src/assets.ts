...
public static readonly Collision1:{w:number; h:number} = {w:400, h:400}
public static readonly Collision2:{w:number; h:number} = {w:232, h:232}
public static readonly Collision3:{w:number; h:number} = {w:250, h:118}
public static readonly Collision4:{w:number; h:number} = {w:250, h:118}
public static readonly Collision5:{w:number; h:number} = {w:230, h:230}
public static readonly Collision6:{w:number; h:number} = {w:250, h:120}
public static readonly Collision7:{w:number; h:number} = {w:250, h:120}
public static readonly Collision8:{w:number; h:number} = {w:230, h:230}
public static readonly Collision9:{w:number; h:number} = {w:220, h:220}
public static readonly Collision10:{w:number; h:number} = {w:250, h:250}
...
public static readonly XmlURL: string =  'assets/bitmapfonts/helvetica_regular.xml'
public static readonly PngURL: string =  'assets/bitmapfonts/helvetica_regular.png'
}
}
export namespace Images {
export class Background {
public static readonly Name: string =  'background_0'
public static readonly FileURL: string =  'assets/images/background_0.png'
public static readonly Extension: string =  '.png'
public static readonly Size: string =  '264579'
}
export class Background1 {
public static readonly Name: string =  'background_1'
public static readonly FileURL: string =  'assets/images/background_1.png'
public static readonly Extension: string =  '.png'
public static readonly Size: string =  '1503130'
}
export class Background2 {
public static readonly Name: string =  'background_2'
public static readonly FileURL: string =  'assets/images/background_2.png'
public static readonly Extension: string =  '.png'
...
public static readonly Name: string =  'translation'
public static readonly FileURL: string =  'assets/locales/en/translation.json'
public static readonly Extension: string =  '.json'
public static readonly Size: string =  '110'
}
}
export namespace Ru {
export class Translation {
public static readonly Name: string =  'translation'
public static readonly FileURL: string =  'assets/locales/ru/translation.json'
public static readonly Extension: string =  '.json'
public static readonly Size: string =  '28'
}
}
}
