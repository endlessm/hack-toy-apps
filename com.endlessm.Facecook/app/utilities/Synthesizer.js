...
{	
	...
	//------------------------------------------------------------
	this.playNote = function( pitch, duration, attack, release )
	{
		...
		if ( n != NULL_NOTE )
		{
			...
			_notes[n].overtone.frequency.setValueAtTime( convertedOvertonePitch, 0 );
  			...
  			_notes[n].baseEnvelope.gain.setTargetAtTime( BASE_VOLUME, 0, _notes[n].attack );
  			_notes[n].overEnvelope.gain.setTargetAtTime( OVER_VOLUME, 0, _notes[n].attack );
